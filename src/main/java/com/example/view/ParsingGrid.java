...
import com.example.ui.ParsingEditor;
...
public class ParsingGrid extends VerticalLayout {
    ...
    public ParsingGrid(UserRepository repo, UserEditor editor, JdbcTemplate jdbcTemplate) {
    ...
    public void init(){
        ...
        grid.setColumns( "address", "cleanAddress", "region" );
        ...
        grid.setItems( jdbcTemplate.query(
                ...
                ps -> {
                    ...
                    if( !StringUtils.isEmpty(region)){
                        //if (region =="!") ps.setString( pCount, "%" + correctAddress + "%" ) pCount++;
                        //else
